...
const List<String> configGroups = [
  'Spotify',
  'Theme',
  'Privacy',
  'Features',
...
const List<ConfigKey> configKeys = [
  ...
  ConfigKey(
    section: 'Preprocesses',
    key: 'disable_ui_logging',
    label: 'Disable UI logging',
    group: 'Privacy',
    kind: FieldKind.toggle,
  ),
  ConfigKey(
